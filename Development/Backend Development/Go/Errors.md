In [[Go]], an error is an [[Development/Backend Development/Java/Interfaces|interface]] type, built-in like any other. Therefore, no rigid or special control structures are required for error handling.
